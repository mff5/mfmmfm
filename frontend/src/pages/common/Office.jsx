                ...
                <div className="member-office-container">
                    ...
                    <div className="member-office-gallery">
                        <div className="main-image">
                            <img src={`/src/assets/${office.titleImg}`} alt="오피스 사진" className="main-office-image" />
                        </div>
                        <div className="sub-images">
                            <img src={`/src/assets/${office.subImg1}`} alt="오피스 사진 1" className="sub-office-image" />
                            <img src={`/src/assets/${office.subImg2}`} alt="오피스 사진 2" className="sub-office-image" />
                        </div>
                    </div>
